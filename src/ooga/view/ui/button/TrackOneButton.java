...
public class TrackOneButton extends Buttons {

  private static final String PNG_EXTENSION = ".png";
  private static final String TRACK_PATH = "data/Tracks/track1";
  private static final Dimension DEFAULT_SIZE = new Dimension(300, 200);
  private static Controller controller;
  private static Model model;
  private final int level = 1;
  private final int css_file_number = 3;
   ...
   */
  public TrackOneButton(Controller controller, Model model) {
    super(new Button(), "OptionButtonOne");
  ...
  public void initializeThisButton() {
    ...
    super.getCurrButton().setOnAction(event -> {
      ...
      controller.startMainGame(css_file_number); //magic number
      //model.createDefaultPath(model.getPath());
  ...
  public void setTextAndID() {
    getCurrButton().setId("OptionButtonOne");
  }
}