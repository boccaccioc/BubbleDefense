...
public class TrackTwoButton extends Buttons {

  private static final String PNG_EXTENSION = ".png";
  private static final String TRACK_PATH = "data/Tracks/track2";
  private static final Dimension DEFAULT_SIZE = new Dimension(300, 200);
  private static Controller controller;
  private static Model model;
  private final int level = 2;
  private final int css_file_number = 2;
   ...
   */
  public TrackTwoButton(Controller controller, Model model) {
    super(new Button(), "OptionButtonTwo");
  ...
  public void initializeThisButton() {
    ...
    super.getCurrButton().setOnAction(event -> {
      ...
      //model.createDefaultPath2(model.getPath());
  ...
  public void setTextAndID() {
    getCurrButton().setId("OptionButtonTwo");
  }
}
